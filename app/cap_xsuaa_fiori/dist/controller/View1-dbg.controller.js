sap.ui.define([
    ...
    function (Controller, Dialog, Input, Button, Text, Label, Core,MessageBox) {
        ...
        var that;
        var appModulePath;
        return Controller.extend("capxsuaafiori.capxsuaafiori.controller.View1", {
            onInit: function () {
                that = this;
            ...
            read: function () {
                let sUrl = appModulePath + "catalog/CompanyCode";
                ...
                if (!this.oDraggableDialog) {
                    this.oDraggableDialog = new Dialog({
                        ...
                        endButton: new Button({
                            ...
                            press: function () {
                                debugger;
                                var sUrl = appModulePath + "catalog/CompanyCode";
                                var payload = {};
            ...
            delete: function (oEvent) {
                ...
                var sUrl = appModulePath + "main/Materials/" + selectedObject.MaterialNumber;
